                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{route('medico.update', $medicos->id)}}" method="POST">
                                        @method('PUT')
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="code" name="code" value="{{ $medicos->code }}" required>
                                                    <small class="text-muted">Ejemplo: MED-001</small>
                                                </div>

                                                <div class="form-group mb-3">
                                                    <label for="name">Nombre Completo</label>
                                                    <input type="text" class="form-control" id="name" name="name"  value="{{ $medicos->name }}" required>
                                                </div>

                                                <div class="form-group mb-3">
                                                    <label for="specialty">Especialidad</label>
                                                    <input type="text" class="form-control" id="specialty" name="specialty" value="{{ $medicos->specialty }}" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="phone" name="phone" value="{{ $medicos->phone }}" required>
                                                </div>

                                                <div class="form-group mb-3">
                                                    <label for="email">Correo Electrónico</label>
                                                    <input type="email" class="form-control" id="email" name="email" value="{{ $medicos->email }}" required>
                                                </div>
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select class="form-control" id="establecimiento_id" name="establecimiento_id" required>
                                                        ...
                                                        @foreach ($establecemientos as $location)
                                                            <option value="{{$location->id}}">
                                                                {{ old('establecimiento_id', $medicos->establecimiento_id) == $location->id ? 'selected' : '' }}>
                                                                    {{ $location->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>

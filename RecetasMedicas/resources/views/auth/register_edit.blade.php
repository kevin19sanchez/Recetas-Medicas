                    ...
                    <div class="row">
                        <div class="col-md-8 offset-md-2">
                            ...
                            @endif
                                    ...
                                    <form action="{{route('register.update', $useredit->id)}}" method="POST">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('name') is-invalid @enderror"
                                                id="name" name="name" value="{{ old('name', $useredit->name) }}" required>
                                            @error('name')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="email" class="form-control @error('email') is-invalid @enderror"
                                                id="email" name="email" value="{{ old('email', $useredit->email) }}" required>
                                            @error('email')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('role') is-invalid @enderror" id="role" name="role" required>
                                                ...
                                                <option value="admin" {{ old('role', $useredit->role) == 'admin' ? 'selected' : '' }}>Administrador</option>
                                                <option value="medico" {{ old('role', $useredit->role) == 'medico' ? 'selected' : '' }}>Médico</option>
                                                <option value="paciente" {{ old('role', $useredit->role) == 'paciente' ? 'selected' : '' }}>Paciente</option>
                                            </select>
                                            @error('role')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3" id="secretKeyDiv" style="display: none;">
                                            ...
                                            id="admin_secret" name="admin_secret" value="{{ old('email', $useredit->admin_secret) }}">
                                            @error('secret_key')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3" id="licenseDivs" style="display: none;">
                                            ...
                                            id="license_number" name="license_number" value="{{ old('email', $useredit->license_number) }}">
